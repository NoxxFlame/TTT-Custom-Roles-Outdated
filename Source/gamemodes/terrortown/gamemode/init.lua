...
CreateConVar("ttt_traitor_pct", "0.25", FCVAR_ARCHIVE)
CreateConVar("ttt_traitor_max", "32", FCVAR_ARCHIVE)

CreateConVar("ttt_detective_pct", "0.13", FCVAR_ARCHIVE + FCVAR_NOTIFY)
CreateConVar("ttt_detective_max", "32", FCVAR_ARCHIVE)
...
CreateConVar("ttt_jester_enabled", "1", FCVAR_ARCHIVE)
CreateConVar("ttt_phantom_enabled", "1", FCVAR_ARCHIVE)
CreateConVar("ttt_zombie_enabled", "1", FCVAR_ARCHIVE)
CreateConVar("ttt_vampire_enabled", "1", FCVAR_ARCHIVE)
...
CreateConVar("ttt_assassin_chance", "0.2", FCVAR_ARCHIVE)
CreateConVar("ttt_glitch_chance", "0.25", FCVAR_ARCHIVE)
CreateConVar("ttt_phantom_chance", "0.25", FCVAR_ARCHIVE)
CreateConVar("ttt_mercenary_chance", "0.25", FCVAR_ARCHIVE)
...
CreateConVar("ttt_jester_required_innos", "2", FCVAR_ARCHIVE)
CreateConVar("ttt_phantom_required_innos", "2", FCVAR_ARCHIVE)
CreateConVar("ttt_zombie_required_traitors", "2", FCVAR_ARCHIVE)
CreateConVar("ttt_vampire_required_traitors", "2", FCVAR_ARCHIVE)
...
CreateConVar("ttt_credits_award_pct", "0.35", FCVAR_ARCHIVE)
CreateConVar("ttt_credits_award_size", "1", FCVAR_ARCHIVE)
CreateConVar("ttt_credits_award_repeat", "1", FCVAR_ARCHIVE)
CreateConVar("ttt_credits_detectivekill", "1", FCVAR_ARCHIVE)

CreateConVar("ttt_credits_alonebonus", "1", FCVAR_ARCHIVE)

-- Detective credits
CreateConVar("ttt_det_credits_starting", "1", FCVAR_ARCHIVE)
...
function SelectRoles()
    ...
    if GetConVar("ttt_monsters_are_traitors"):GetBool() and (GetConVar("ttt_zombie_enabled"):GetBool() and math.random() <= zombie_chance and not hasTraitor and not hasSpecial) or hasZombie then
        ...
        while ts < traitor_count and #choices > 0 do
            ...
            if GetConVar("ttt_monsters_are_traitors"):GetBool() then
    ...
    if not GetConVar("ttt_monsters_are_traitors"):GetBool() then
