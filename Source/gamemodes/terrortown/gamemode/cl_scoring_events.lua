...
Event(EVENT_KILL,
{
    ...
    icon = function(e)
        ...
        local attacker = (e.att.tr and "Traitor") or (e.att.mon and "Monster") or (e.att.kil and "Killer") or (e.att.jes and "Jester") or "Innocent"
        local victim = (e.vic.tr and "Traitor") or (e.vic.mon and "Monster") or (e.vic.kil and "Killer") or (e.vic.jes and "Jester") or "Innocent"
        if e.tk then
            return wrong_icon, "Teamkill"
        elseif e.att.tr or e.att.mon or e.att.kil then
