...
function GetEquipmentForRole(role)
	...
	for k, v in pairs(Mfiles) do
		...
		for k, v in pairs(Mplayers) do
			if table.HasValue(weapons.GetStored(v.name).CanBuy, ROLE_MERCENARY) then
			else
				table.insert(weapons.GetStored(v.name).CanBuy, ROLE_MERCENARY)
			end
		end
	end
	...
	for k, v in pairs(Zfiles) do
		...
		for k, v in pairs(Zplayers) do
			if table.HasValue(weapons.GetStored(v.name).CanBuy, ROLE_ZOMBIE) then
			else
				table.insert(weapons.GetStored(v.name).CanBuy, ROLE_ZOMBIE)
			end
		end
	end
	...
	for k, v in pairs(Hfiles) do
		...
		for k, v in pairs(Hplayers) do
			if table.HasValue(weapons.GetStored(v.name).CanBuy, ROLE_HYPNOTIST) then
			else
				table.insert(weapons.GetStored(v.name).CanBuy, ROLE_HYPNOTIST)
			end
		end
	end
	...
	for k, v in pairs(Vfiles) do
		...
		for k, v in pairs(Vplayers) do
			if table.HasValue(weapons.GetStored(v.name).CanBuy, ROLE_VAMPIRE) then
			else
				table.insert(weapons.GetStored(v.name).CanBuy, ROLE_VAMPIRE)
			end
		end
	end
	...
	for k, v in pairs(Afiles) do
		...
		for k, v in pairs(Aplayers) do
			if table.HasValue(weapons.GetStored(v.name).CanBuy, ROLE_ASSASSIN) then
			else
				table.insert(weapons.GetStored(v.name).CanBuy, ROLE_ASSASSIN)
			end
		end
	end
