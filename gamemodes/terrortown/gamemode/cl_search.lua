...
local function IconForInfoType(t, data)
	...
	if symbols then
		TypeToMat = {
			...
			eq_radar = "radar",
			eq_disg = "disguise",
			role = { [ROLE_TRAITOR] = "sym_tra", [ROLE_DETECTIVE] = "sym_det", [ROLE_MERCENARY] = "sym_mer", [ROLE_HYPNOTIST] = "sym_hyp", [ROLE_GLITCH] = "sym_gli", [ROLE_JESTER] = "sym_jes", [ROLE_PHANTOM] = "sym_pha", [ROLE_ZOMBIE] = "sym_zom", [ROLE_VAMPIRE] = "sym_vam", [ROLE_SWAPPER] = "sym_swa", [ROLE_ASSASSIN] = "sym_ass", [ROLE_INNOCENT] = "sym_inn" },
			c4 = "code",
			dmg = DmgToMat,
			wep = WeaponToIcon,
			head = "head",
		...
		TypeToMat = {
			...
			eq_radar = "radar",
			eq_disg = "disguise",
			role = { [ROLE_TRAITOR] = "let_tra", [ROLE_DETECTIVE] = "let_det", [ROLE_MERCENARY] = "let_mer", [ROLE_HYPNOTIST] = "let_hyp", [ROLE_GLITCH] = "let_gli", [ROLE_JESTER] = "let_jes", [ROLE_PHANTOM] = "let_pha", [ROLE_ZOMBIE] = "let_zom", [ROLE_VAMPIRE] = "let_vam", [ROLE_SWAPPER] = "let_swa", [ROLE_ASSASSIN] = "let_ass", [ROLE_INNOCENT] = "let_inn" },
			c4 = "code",
			dmg = DmgToMat,
			wep = WeaponToIcon,
			head = "head",
