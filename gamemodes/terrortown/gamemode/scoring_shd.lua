...
function ScoreEventLog(events, scores, traitors, detectives, hypnotists, mercenaries, jesters, phantoms, glitches, zombies, vampires, swappers, assassins, killers, doctors, detraitors)
	for k, s in pairs(scores) do
		...
		scores[k].was_zombie = table.HasValue(zombies, k)
		...
		scores[k].was_doctor = table.HasValue(doctors, k)
		scores[k].was_detraitor = table.HasValue(detraitors, k)
	end
